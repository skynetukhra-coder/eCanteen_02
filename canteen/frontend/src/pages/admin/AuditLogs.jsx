...
function AuditLogs() {
    ...
    return (
        <div className="wallet-page" style={{ padding: "0 0 20px 0" }}>
            <div className="wallet-header" style={{ marginBottom: "25px" }}>
                <h1>System Security Audit Logs</h1>
                <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                    <button className="verify-btn" style={{ background: "#3b82f6" }} onClick={fetchLogs}>
                        <FaSync />
                        Refresh
                    </button>
                ...
                <div style={{ display: "flex", gap: "15px", alignItems: "flex-end", flexWrap: "wrap" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                        ...
                        <select 
                            ...
                            style={{ padding: "8px 12px", borderRadius: "6px", border: "1px solid #cbd5e1", fontSize: "14px", width: "160px", background: "#ffffff" }}
                        >
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                        ...
                        <input 
                            ...
                            style={{ padding: "7px 12px", borderRadius: "6px", border: "1px solid #cbd5e1", fontSize: "14px" }}
                        />
                    </div>
